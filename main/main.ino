...
// Envio dos dados:
  ...
  SerialBT.print(g1.acceleration.x); SerialBT.print(",");
  SerialBT.print(g1.acceleration.y); SerialBT.print(",");
  SerialBT.print(g1.acceleration.z); SerialBT.print(",");
  ...
  SerialBT.print(g2.acceleration.x); SerialBT.print(",");
  SerialBT.print(g2.acceleration.y); SerialBT.print(",");
  SerialBT.println(g2.acceleration.z);
